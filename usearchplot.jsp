...
<tr ><td colspan="3" align="center" class="font_head">Search Plot</td></tr>
...
<table width="80%" align="center" bgcolor="#FFFFFF">
	  <tr>
				 <td colspan="8" align="center"><B>Plot Details</B></td>
	  </tr>
...
try
	...
	Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
		...
		ResultSet rs1=stmt1.executeQuery("select * from plots where city='"+ct+"'");
		while(rs1.next())
		{
		int rid=rs1.getInt("rid");
		String ar=rs1.getString("area");
		int pr=rs1.getInt("price");
		String det=rs1.getString("pdesc");
...
{
out.println("<script language='javascript'> alert('No Plot Found.'); </script>");
}
con.close();
