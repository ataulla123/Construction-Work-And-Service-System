 ...
 if(document.frm.cmbcity.value=="")
	...
	var mb1 = document.frm.txtcont.value;
	 if(isNaN(mb1)||mb1.indexOf(" ")!=-1)
           {
              alert("Enter Contact In Digits")
              return false;
           }
		   if (mb1.length<7)
           {
                alert("Enter 7 characters For Contact Number");;
                return false;
           }
...
<body>
		...
		<td>
		<table width="80%" border="1" bgcolor="#0000FF"  align="center">
...
<table width="85%" height="300"  align="center" border="0" bgcolor="#fff">
<tr><td colspan="2" align="center" height="100"></td></tr>
<tr ><td colspan="4" align="center" class="font_head">Builder's Registration</td></tr>
...
<td> <select name="cmbcity" class="txt1">
               ...
               %>
						...
						<tr><td colspan="2" align="center" height="10"></td></tr>
<tr>	
<td class="font_normal">Company Name :</td>
<td><input type="text" name="txtname" class="txt" ></td>

<td class="font_normal">Contact Number :</td>
<td><input type="text" name="txtcont"  class="txt" ></td>
...
<td colspan="3"><textarea class="txt2" name="txtadr" rows="4" cols="88"></textarea></td>
</tr> 
<tr><td colspan="2" align="center" height="10"></td></tr>
...
if(ext==1)
{
 out.println("<script language='javascript'> alert('Builder's Name already there'); </script>");
}
else
{
smt.executeUpdate("insert into registration(typ,city,name,cont,uid,pass,adr)values('Builder','"+city+"','"+nam+"','"+cont+"','"+uid+"','"+pass+"','"+adr+"')");
out.println("<script language='javascript'> alert('Builder registerd successfully.'); </script>");
}
}
catch(Exception e)
{
