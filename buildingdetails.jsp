...
smt.executeUpdate("insert into buildings(rid,city,area,price,bdesc)values("+session.getAttribute("builder")+",'"+city+"','"+area+"',"+price+",'"+des+"')");

out.println("<script language='javascript'> alert('Building Details added Successfully.'); </script>");
con.close();
...
<tr ><td colspan="4" align="center" class="font_head">Building Details</td></tr>
...
<table width="90%" align="center" bgcolor="#FFFFFF">
	  <tr>
				 <td colspan="8" align="center"><B>View Building Details</B></td>
	  </tr>
...
try
	...
	Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
		Connection con=DriverManager.getConnection("Jdbc:Odbc:cwss");
		java.sql.Statement stmt=con.createStatement();
		ResultSet rs=stmt.executeQuery("select * from buildings where rid="+session.getAttribute("builder")+"");
		while(rs.next())
		{
		int id=rs.getInt("bdid");
...
%>             <tr>
			  ...
			  <td  align="left"><div align="center"><a href="editbuilding.jsp?id=<%=id%>" onclick="return confirm('Are you sure you want to Edit this Building Details?');"><font color="#00FF00" size="3">Edit</font></a></div>
			     <td  align="left"><div align="center"><a href="deletebuilding.jsp?id=<%=id%>" onclick="return confirm('Are you sure you want to Delete this Building Details?');"><font color="#ff0000" size="3">Delete</font></a></div>
