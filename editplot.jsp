...
ResultSet rs=smt.executeQuery("select * from Plots where pid="+request.getParameter("id")+"");
		while(rs.next())
		{
		 area1=rs.getString("area");
		 price1=rs.getInt("price");
		 des1=rs.getString("pdesc");
		}
		con.close();
...
<tr ><td colspan="4" align="center" class="font_head">Edit Plot Details</td></tr>
...
smt.executeUpdate("update Plots set area='"+area+"',price="+price+",pdesc='"+des+"' where pid="+request.getParameter("id")+"");

out.println("<script language='javascript'> alert('Plot Details Updated Successfully.'); </script>");
con.close();
