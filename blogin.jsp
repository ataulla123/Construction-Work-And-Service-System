...
<tr ><td colspan="2" align="center" class="font_head">Builder Login</td></tr>
...
ResultSet rs=smt.executeQuery("select * from registration where typ='Builder' and uid='"+uid+"' and pass='"+pass+"'");
while(rs.next())
{
ext=1;
rid=rs.getInt("rid");
...
if(ext==1)
{
 session.setAttribute("builder",""+rid);
