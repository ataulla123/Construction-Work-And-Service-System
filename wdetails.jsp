...
smt.executeUpdate("insert into workcharges(wrid,wtit,wfees)values("+session.getAttribute("worker")+",'"+det+"',"+amt+")");
out.println("<script language='javascript'> alert('Work Details Added Successfully.'); </script>");
...
<tr ><td colspan="2" align="center" class="font_head">Work Details</td></tr>
...
<td><font color="#000"><textarea name="txtdet" rows="3" cols="40"></textarea></font></td>
</tr>
<tr><td colspan="2" align="center" height="10"></td></tr>
<tr>
<td class="font_normal">Work Charges :</td>
<td><input type="text" name="txtamt" class="txt"></td>
</tr>
<tr><td colspan="2" align="center" height="10"></td></tr>
...
<table width="90%" align="center" bgcolor="#FFFFFF">
	...
	<td width="160"><div align="center"> <font color="#fff">Charges</font></div></td>
...
try
	...
	Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
		...
		ResultSet rs2=stmt.executeQuery("select * from workcharges where wrid='"+session.getAttribute("worker")+"' order by wid");
while(rs2.next())
{
...
%>             <tr>
              ...
              <td  align="left"><div align="center"> <%=tit%></div></td>
			   <td  align="left"><div align="center"><%=fes%></div></td>
			      <td  align="left"><div align="center"><a href="editwdetails.jsp?wid=<%=wid%>" onclick="return confirm('Are you sure you want to Edit this Work Details ?');"><font color="#00FF00" size="3">Edit</font></a></div>
			     <td  align="left"><div align="center"><a href="deletewdetails.jsp?wid=<%=wid%>" onclick="return confirm('Are you sure you want to Delete this Work Details ?');"><font color="#ff0000" size="3">Delete</font></a></div>
