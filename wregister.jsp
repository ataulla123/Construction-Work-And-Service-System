...
<tr ><td colspan="4" align="center" class="font_head">Worker's Registration</td></tr>
...
<option>Other</option>
						...
						<tr><td colspan="2" align="center" height="10"></td></tr>
<tr>	
<td class="font_normal">Worker Name :</td>
...
if(ext==1)
{
 out.println("<script language='javascript'> alert('Workers's Name already there'); </script>");
}
else
{
smt.executeUpdate("insert into registration(typ,rtyp,city,name,cont,uid,pass,adr)values('Worker','"+request.getParameter("cmbcat")+"','"+city+"','"+nam+"','"+cont+"','"+uid+"','"+pass+"','"+adr+"')");
out.println("<script language='javascript'> alert('Worker registerd successfully.'); </script>");
}
}
catch(Exception e)
{
