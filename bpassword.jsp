...
ResultSet rs=smt.executeQuery("select * from registration where pass='"+oldpass+"' and rid="+session.getAttribute("builder")+"");
while(rs.next())
{
ext=1;
}
...
{
smt.executeUpdate("Update registration set pass='"+newpass+"' where rid="+session.getAttribute("builder")+"");
